...
function Home () {
  ...
  const [movies, setMovies] = useState([
    { titre: 'Code and Furious', description: 'Action , Course ,Drogue ,Adrénaline, Adventure', posterURL: 'https://static.posters.cz/image/750webp/114155.webp', note: 9.8 , trailer:"rPmA-4AhA94?si=Vh8pHFwr4TX-8FkJ"},
    { titre: 'Film 2', description: 'Description du film 2', posterURL: 'http://cdn.collider.com/wp-content/uploads/2017/05/blade-runner-2049-poster-ryan-gosling.jpeg', note: 3,trailer:"gCcx85zbxz4?si=9nbzbR8RtV4t7Kpr" },
    { titre: 'Joke Air', description: 'Description du film 3', posterURL: 'https://media.senscritique.com/media/000018727645/300/joker.jpg', note: 7.5 ,trailer:"zAGVQLHvwOY?si=WULjJeXtQdMMrwWo"},
    { titre: 'Mad MAX Fury road', description: 'Description du film 4', posterURL: 'https://media.senscritique.com/media/000017108234/300/mad_max_fury_road.jpg', note: 7 , trailer:"hEJnMQG9ev8?si=hBV8DFjRACiaAnpB"},
    { titre: 'TU NE TUERAS POINT', description: 'Film Chrétien basé sur un des dix commandement', posterURL: 'https://media.senscritique.com/media/000016515800/300/tu_ne_tueras_point.jpg', note: 10 , trailer:"ckL-Rf8K__Q?si=P3ePgTnpe9iSpArl" },
    { titre: 'BABY DRIVER', description: 'Course poursuite , Action , adrenaline', posterURL: 'https://aws3.vdkimg.com/film/1/3/3/8/1338851_poster_scale_480x640.jpg', note: 8 ,trailer:"zTvJJnoWIPk?si=rcwxxUvICL15jTti" },
  ]);
      ...
      <div className="d-flex justify-content-center h-100">
        ...
        <div className="search">
          <input type="number" className="search-input" placeholder="note" name="note"
            value={note} min={0} max={10} onChange={e => setNote(e.target.value)} />
          <a href="#" className="search-icon">
